...
describe('conditionals', () => {
  ...
  describe('eq', () => {
    ...
    it('helper should work as expected after compilation', () => {
      const template = compile('{{eq value 1}}');

      expect(template({ value: '1' })).toEqual('false');
    });

    it('helper could be used in if', () => {
      const template = compile('{{#if (eq value "1")}}Just Wow{{/if}}');
  ...
  describe('eqw', () => {
    ...
    it('helper should work as expected after compilation', () => {
      const template = compile('{{eqw value 1}}');

      expect(template({ value: '1' })).toEqual('true');
    });

    it('helper could be used in if', () => {
      const template = compile('{{#if (eqw value 1)}}Just Wow{{/if}}');
  ...
  describe('neq', () => {
    ...
    it('helper should work as expected after compilation', () => {
      const template = compile('{{neq value 1}}');

      expect(template({ value: 1 })).toEqual('false');
    });

    it('helper could be used in if', () => {
      const template = compile('{{#if (neq value 1)}}Just Wow{{/if}}');
  ...
  describe('neqw', () => {
    ...
    it('helper should work as expected after compilation', () => {
      const template = compile('{{neqw value 1}}');

      expect(template({ value: '1' })).toEqual('false');
    });

    it('helper could be used in if', () => {
      const template = compile('{{#if (neqw value 2)}}Just Wow{{/if}}');
  ...
  describe('lt', () => {
    ...
    it('helper should work as expected after compilation', () => {
      const template = compile('{{lt value 1}}');

      expect(template({ value: 2 })).toEqual('false');
    });

    it('helper could be used in if', () => {
      const template = compile('{{#if (lt value 5)}}Just Wow{{/if}}');
  ...
  describe('lte', () => {
    ...
    it('helper should work as expected after compilation', () => {
      const template = compile('{{lte value 1}}');

      expect(template({ value: 2 })).toEqual('false');
    });

    it('helper could be used in if', () => {
      const template = compile('{{#if (lte value 4)}}Just Wow{{/if}}');
  ...
  describe('gt', () => {
    ...
    it('helper should work as expected after compilation', () => {
      const template = compile('{{gt value 2}}');

      expect(template({ value: 1 })).toEqual('false');
    });

    it('helper could be used in if', () => {
      const template = compile('{{#if (gt value 2)}}Just Wow{{/if}}');
  ...
  describe('gte', () => {
    ...
    it('helper should work as expected after compilation', () => {
      const template = compile('{{gte value 1}}');

      expect(template({ value: 1 })).toEqual('true');
    });

    it('helper could be used in if', () => {
      const template = compile('{{#if (gte value 1)}}Just Wow{{/if}}');
  ...
  describe('ifx', () => {
    ...
    it('helper should work as expected with multiple level of nested helpers', () => {
      const template = compile('{{ifx (not (eq value 1)) 5 6}}');
    ...
    it('allows to skip the third parameter', () => {
      const template = compile('{{ifx isActive "active"}}');
  ...
  describe('not', () => {
    ...
    it('helper should work as expected after compilation', () => {
      const template = compile('{{not boolean}}');

      expect(template({ boolean: false })).toEqual('true');
    });

    it('helper could be used in if', () => {
      const template = compile('{{#if (not (eq value 4))}}Just Wow{{/if}}');
  ...
  describe('empty', () => {
    ...
    it('helper should work as expected after compilation', () => {
      const template = compile('{{empty array}}');

      expect(template({ array: [] })).toEqual('true');
    });

    it('helper could be used in if', () => {
      const template = compile('{{#if (empty arr)}}Just Wow{{/if}}');
  ...
  describe('count', () => {
    ...
    it('helper should work as expected after compilation', () => {
      const template = compile('{{count array}}');
  ...
  describe('and', () => {
    ...
    it('should return true if all the parameters are true after compilation', () => {
      const template = compile('{{and condition1 condition2 condition3}}');
  ...
  describe('or', () => {
    ...
    it('should return false if all the parameters are false after compilation', () => {
      const template = compile('{{or condition1 condition2 condition3}}');
    ...
    it('should work fine with direct boolean values', () => {
      const template = compile('{{concat "The or operator: " (or false false)}}');
  ...
  describe('coalesce', () => {
    ...
    it('should return first non-false parameter after compilation', () => {
      const template = compile('{{coalesce fullName nickName "Unknown"}}');
  ...
  describe('includes', () => {
    it('should return true if array strictly includes the element after compilation', () => {
      ...
      const template = compile('{{includes array value}}');
    ...
    it('should return true if array non-strictly includes the element after compilation', () => {
      const value = '3';
      const array = [1, 2, 3, 4, 5];
      const template = compile('{{includes array value false}}');
